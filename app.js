...
function rRpt(){const c=calc();
  ...
  return '<div style="max-width:1100px">'+
    '<div style="text-align:center;margin-bottom:20px"><div style="font-size:22px;font-weight:700;color:#1e3a5f">태성㈜ 자금운용보고서</div><div style="font-size:13px;color:#64748b;margin-top:4px">'+rptDt()+' 기준</div></div>'+
    ...
    // 1. 총자산내역
    '<div style="font-size:15px;font-weight:700;margin-bottom:8px;color:#1e3a5f">1. 총자산내역</div>'+
    ...
    // 2. 유가증권 평가 및 손익 현황
    '<div style="font-size:15px;font-weight:700;margin:20px 0 8px;color:#1e3a5f">2. 유가증권 평가 및 손익 현황</div>'+
    ...
    // 가) 일본
    '<div style="font-size:13px;font-weight:700;margin-bottom:6px">가) 일본</div>'+
    ...
    // 나) 미국
    '<div style="font-size:13px;font-weight:700;margin-bottom:6px">나) 미국</div>'+
    ...
    // 다) 전체
    '<div style="font-size:13px;font-weight:700;margin-bottom:6px">다) 전체</div>'+
    ...
    // 3. 수익실현내역
    '<div style="font-size:15px;font-weight:700;margin:20px 0 8px;color:#1e3a5f">3. 수익실현내역</div>'+
    ...
    // 4. 은행 법인 계좌 상세 내역
    '<div style="font-size:15px;font-weight:700;margin:20px 0 8px;color:#1e3a5f">4. 은행 법인 계좌 상세 내역</div>'+
...
// updateNavLabels() in lang.js;
  document.querySelectorAll('.nav-item').forEach(el=>{
    const pg=el.dataset.page;if(pg&&labels[pg]){el.querySelector('span:last-child').textContent=labels[pg];}
  });
